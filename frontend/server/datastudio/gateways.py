...
Byaan API key in the server process and proxies the REST external asset
contract used by Knowledge Center and generated Data Studio function tools.
"""
...
def datastudio_runtime_api_key_env() -> str:
    return "BYAAN_MCP_API_KEY"
