...
.direction-editorial .panel,.direction-executive .panel{box-shadow:0 1px 0 rgba(16,24,40,.04)}.direction-operational .page-head h1{font-size:32px}.direction-compact .page-head h1{font-size:28px}@media (max-width:520px){.direction-operational .sop-aside{grid-template-columns:1fr}.artifact.direction-operational[data-template="sop"]{padding:16px 0 24px}.artifact.direction-operational[data-template="sop"] .sop-context-panel{padding:24px}.artifact.direction-operational .sop-run-case{display:flex;align-items:flex-start}.artifact.direction-operational .sop-run-case .state{display:inline-block;margin-top:8px}.artifact.direction-operational[data-template="sop"] .sop-flow{padding:24px 24px 0}.artifact.direction-operational .sop-flow>.section-head{display:block}.artifact.direction-operational .sop-flow>.section-head .secondary-action{margin-top:10px}.artifact.direction-operational .step-card{grid-template-columns:34px minmax(0,1fr);gap:10px;padding:16px}.artifact.direction-operational .step-index{font-size:18px}.artifact.direction-operational .step-top{display:block}.artifact.direction-operational .step-top .state{display:inline-block;margin-top:8px}.artifact.direction-operational .step-detail{gap:6px;display:block}.artifact.direction-operational .step-detail span{display:block;margin-top:3px}.artifact.direction-operational[data-template="sop"] .sop-result{padding:24px}.artifact.direction-operational .result-actions{gap:8px}}
