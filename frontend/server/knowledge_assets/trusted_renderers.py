...
def _sop_tone(step: object) -> str:
    """Map persisted step semantics to the prototype's visual state tone."""
    status = str(getattr(step, "status", "") or "")
    message = str(getattr(step, "message", "") or "")
    if status == "failed" or any(token in message for token in ("异常", "失败", "不合格")):
...
.artifact.direction-executive[data-template="dashboard"] .kpi-grid{grid-template-columns:repeat(4,minmax(0,1fr));gap:26px;margin-bottom:18px}.artifact.direction-executive[data-template="dashboard"] .kpi{min-height:164px;padding:20px}.artifact.direction-executive[data-template="dashboard"] .metric{font-size:25px;margin:10px 0 6px}.artifact.direction-executive[data-template="dashboard"] .chart-grid{grid-template-columns:1fr;gap:10px}.artifact.direction-executive[data-template="dashboard"] .panel{padding:18px;margin-bottom:14px;border-radius:10px}.artifact.direction-executive[data-template="dashboard"] .chart-panel{min-height:300px}
...
.direction-editorial .panel,.direction-executive .panel{box-shadow:0 1px 0 rgba(16,24,40,.04)}.direction-operational .page-head h1{font-size:32px}.direction-compact .page-head h1{font-size:28px}@media (max-width:520px){.direction-operational .sop-aside{grid-template-columns:1fr}.artifact.direction-operational[data-template="sop"]{padding:16px 0 24px}.artifact.direction-operational[data-template="sop"] .sop-context-panel{padding:24px}.artifact.direction-operational .sop-run-case{display:flex;align-items:flex-start}.artifact.direction-operational .sop-run-case .state{display:inline-block;margin-top:8px}.artifact.direction-operational[data-template="sop"] .sop-flow{padding:24px 24px 0}.artifact.direction-operational .sop-flow>.section-head{display:block}.artifact.direction-operational .sop-flow>.section-head .secondary-action{margin-top:10px}.artifact.direction-operational .step-flow{padding-left:24px;gap:24px}.artifact.direction-operational .step-card{grid-template-columns:34px minmax(0,1fr);gap:10px;padding:16px}.artifact.direction-operational .step-index{font-size:18px}.artifact.direction-operational .step-top{display:block}.artifact.direction-operational .step-top .state{display:inline-block;margin-top:8px}.artifact.direction-operational .step-detail{gap:6px;display:block}.artifact.direction-operational .step-detail span{display:block;margin-top:3px}.artifact.direction-operational[data-template="sop"] .sop-result{padding:24px}.artifact.direction-operational .result-actions{gap:8px}}
...
/* Shared v2.15.2 artifact alignment keeps real revision content on the
   prototype's visual rails without changing the underlying ViewModel. */
.artifact.direction-executive[data-template="dashboard"] .kpi{min-height:164px;padding:20px}
.artifact.direction-operational .step-flow{padding-left:24px}
.artifact.direction-operational .step-card{display:block;position:relative;padding:16px}
.artifact.direction-operational .step-index{position:absolute;left:-24px;top:4px}
.artifact.direction-operational .step-result-succeeded{background:#fff;border-color:#dfe5ec;color:#344054}
.artifact.direction-operational .step-result-awaiting_confirmation{background:#fff5dd;border:1px solid #f6d88a;color:#8a5b00;border-radius:6px;padding:8px 10px}
@media (max-width:520px){
  .artifact.direction-executive[data-template="dashboard"] .kpi{min-height:164px;padding:20px}
  .artifact.direction-operational .step-flow{padding-left:0}
}
"""
    )
