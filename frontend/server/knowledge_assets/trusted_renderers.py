...
.artifact.direction-operational .step-flow{position:relative;padding-left:24px;gap:32px}.artifact.direction-operational .step-flow::before{content:"";position:absolute;left:11px;top:16px;bottom:16px;width:2px;background:#e2e8f0}.artifact.direction-operational .step-card{grid-template-columns:28px minmax(0,1fr);gap:15px;padding:16px}.artifact.direction-operational .step-index{display:grid;place-items:center;width:28px;height:28px;margin-top:1px;border:4px solid var(--surface);border-radius:50%;background:var(--accent);box-shadow:0 1px 3px rgba(16,24,40,.16);font-size:0;position:relative;z-index:1}.artifact.direction-operational .step-index::before{content:attr(data-step-index);font-size:11px;font-weight:700;color:#fff}.artifact.direction-operational .step-number{color:var(--muted);margin-right:6px;font-weight:500}.artifact.direction-operational .step-content h3{font-size:14px}.direction-compact .artifact{padding-top:24px}.direction-compact .panel{padding:14px;border-radius:6px}.direction-compact .kpi{padding:13px;min-height:96px}.direction-compact .metric{font-size:24px}.direction-compact td{padding:8px 10px}
