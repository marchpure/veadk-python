...
.artifact.direction-executive[data-template="dashboard"] .dashboard-ready{display:flex;align-items:center;justify-content:space-between;gap:18px;min-height:102px;margin:0 54px 32px;padding:20px 24px;background:#ecfdf3;border:1px solid #b7ebca;border-radius:12px;box-shadow:0 1px 2px rgba(16,24,40,.04)}
...
.artifact.direction-executive[data-template="dashboard"] .dashboard-ready{margin-left:54px;margin-right:54px}
.artifact.direction-operational .step-flow{padding-left:16px}
.artifact.direction-operational .step-result-succeeded{background:#e9f7f0;border:1px solid #bfe8d3;color:#276749;border-radius:6px;padding:8px 10px}
...
@media (max-width:520px){
  .artifact.direction-executive[data-template="dashboard"] .dashboard-ready{margin-left:0;margin-right:0}
  .artifact.direction-operational .step-flow{padding-left:12px}
}
"""
    )
