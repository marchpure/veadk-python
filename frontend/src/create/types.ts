...
/** An MCP tool server the agent should connect to (becomes a TrustedMcpToolset). */
...
export interface AgentDraft {
  ...
  /** MCP tool servers — the backend generator emits a TrustedMcpToolset per entry. */
  mcpTools?: McpTool[];
  ...
  /** Published Data Studio assets selected for runtime querying. */
