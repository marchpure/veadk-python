...
export default function ArtifactHeader({
  ...
  return (
    <div className="flex flex-col mb-4 w-full select-none pb-8 sm:pb-0">
        ...
        <div className="flex min-w-0 flex-1 flex-col pr-0 sm:pr-4">
          <div className="flex min-w-0 flex-wrap items-center gap-2">
            ...
            {productMode && contextTags.length > 0 && (
              <span className="px-2 py-1 rounded border border-slate-200 bg-slate-100 text-[11px] font-medium text-slate-600 shrink-0 basis-full sm:basis-auto">
