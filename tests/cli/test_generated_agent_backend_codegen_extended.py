...
_MINIMAL_FRONTEND_GOLDEN = {
    ...
    "agents/demo_agent/agent.py": "e3cd28b328e51368037a4bc2b6a1e5ff380051b76aa983ceb2547f556be2dd9a",
...
_FULL_FRONTEND_GOLDEN = {
    ...
    "agents/__init__.py": "a6449a6cac3bfda8b834ea39ea95ca2f8d0471ac480e1e876313d7398eea59ba",
    "agents/full_agent/agent.py": "fa95ca4036bea67a2cd3fd82a0882eeb903928f83dab79bdacb257b1a5ab2011",
...
def test_mcp_token_is_generated_as_runtime_environment_reference() -> None:
    ...
    assert 'os.getenv("MCP_SALES_AGENT_ORDERS_AUTH_TOKEN", "")' in agent_py
    assert 'headers=orders_mcp_headers' in agent_py
...
def test_datastudio_asset_generates_trusted_mcp_and_env_reference() -> None:
    project = generate_project_from_draft(
        AgentDraft(
